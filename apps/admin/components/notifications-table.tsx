...
const baseColumns: ColumnDef<NotificationRow>[] = [
  ...
  },
  {
    ...
    header: 'Tür',
    cell: ({ row }) => (
      <Badge variant="outline">{notificationTypeLabel(row.original.type)}</Badge>
    ),
    filterFn: (row, id, value: string[]) => value.includes(row.getValue(id)),
  },
  {
...
const facets: FacetConfig[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { label: notificationTypeLabel('reconcile_violation'), value: 'reconcile_violation', icon: ShieldAlert },
    ],
  },
];
