        ...
        if (empty($deliveries)) {
            ...
            foreach ($deliveries as $d) {
                ...
                if (!empty($d['validUntil'])) {
                    echo '<li style="list-style:none;margin-left:-16px"><small>' . esc_html__('Geçerlilik:', 'wpteslimat') . ' ' . esc_html(Wpteslimat_My_Account::format_date($d['validUntil'])) . '</small></li>';
                }
            }
            echo '</ul>';
        }
